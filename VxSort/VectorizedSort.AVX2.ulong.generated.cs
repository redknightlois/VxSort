/////////////////////////////////////////////////////////////////////////////
//
// This file was auto-generated by a tool at 2022-12-01 13:12:49
//
...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        internal struct UInt64Config
        {
            ...
            public const int SmallSortThresholdElements = 28 * N;
        ...
        private static ulong* align_left_scalar_uncommon(ulong* read_left, ulong pivot, ref ulong* tmp_left, ref ulong* tmp_right)
        {
            ...
            var next_align = (ulong*)(((ulong)read_left + Sort.ALIGN) & ~Sort.ALIGN_MASK);
        ...
        {        
            ...
            var nextAlign = (ulong*)((ulong)readRight & ~Sort.ALIGN_MASK);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(ulong* dataPtr, V P, byte* pBase, ref ulong* writeLeftPtr, ref ulong* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((ulong*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((ulong*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((ulong*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((ulong*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((ulong*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((ulong*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((ulong*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((ulong*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((ulong*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((ulong*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((ulong*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((ulong*)(dataPtr + N * 11));
            
            partition_block(d12, P, pBase, ref writeLeftPtr, ref writeRightPtr);
            partition_block(d11, P, pBase, ref writeLeftPtr, ref writeRightPtr);
            partition_block(d10, P, pBase, ref writeLeftPtr, ref writeRightPtr);
            partition_block(d9, P, pBase, ref writeLeftPtr, ref writeRightPtr);
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private ulong* vectorized_partition_12(ulong* left, ulong* right, long hint)
        {
            ...
            *right = ulong.MaxValue;
            ...
            for ( int i = 0; i < 2; i++)
                LoadAndPartition12Vectors(pointers[i], P, pBase, ref tmpLeft, ref tmpRight);
            ...
            while (readLeftV < readRightV)
            {
                ...
                LoadAndPartition12Vectors(nextPtr, P, pBase, ref writeLeft, ref writeRight);
            }
        ...
        private static void Pack(void* mem, int len, ulong @base)
        {
            ...
            var pre_aligned_mem = (ulong*) ( (ulong)mem & ~Sort.ALIGN_MASK );
        ...
        private static void Unpack(void* mem, int len, ulong @base)
        {
            ...
            var pre_aligned_mem = (uint*) ( (ulong)mem_read & ~Sort.ALIGN_MASK );           
        ...
        internal void sort(ulong* left, ulong* right, ulong left_hint, ulong right_hint, long hint, int depth_limit)
        {
            ...
            var preAlignedLeft = (ulong*)((ulong)left & ~Sort.ALIGN_MASK);
            ...
            var preAlignedRight = (ulong*)(((ulong)right - 1 & ~Sort.ALIGN_MASK) + Sort.ALIGN);
            ...
            var sep = length < UInt64Config.PartitionTempSizeInElements ?
                vectorized_partition_12(left, right, hint) :
                vectorized_partition_8(left, right, hint);
