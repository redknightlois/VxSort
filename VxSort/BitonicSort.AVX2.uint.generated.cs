...
namespace VxSort
{
    ...
    static unsafe partial class BitonicSort
    {
        ...
        public static void sort_01v_ascending(ref V d01) {
            ...
            max = Max(s, d01);
            d01 = Blend(min, max, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d01, 0x1B)), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
        ...
        public static void sort_01v_merge_ascending(ref V d01) {
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d01), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Blend(min, max, 0xF0);
            s = Shuffle(d01, 0x4E);
    ...
    private static void sort_02v_ascending(ref V d01, ref V d02) {
            ...
            
        {
            ...
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(max, min, 0xAA);

            s = Shuffle(d02, 0x1B);
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(max, min, 0xCC);
            ...
            max = Max(s, d02);
            d02 = Blend(max, min, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d02, 0x1B)), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(max, min, 0xF0);
        ...
        {        
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d02), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(min, max, 0xF0);
            s = Shuffle(d02, 0x4E);
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(min, max, 0xCC);

            s = Shuffle(d02, 0xB1);
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Blend(min, max, 0xAA);
        }
    }
    ...
    private static void sort_03v_ascending(ref V d01, ref V d02, ref V d03) {
            ...
            
        {
            ...
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(max, min, 0xAA);

            s = Shuffle(d03, 0x1B);
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(max, min, 0xCC);
            ...
            max = Max(s, d03);
            d03 = Blend(max, min, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d03, 0x1B)), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(max, min, 0xF0);
        ...
        {        
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d03), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(min, max, 0xF0);
            s = Shuffle(d03, 0x4E);
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(min, max, 0xCC);

            s = Shuffle(d03, 0xB1);
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Blend(min, max, 0xAA);
        }
    }
    ...
    private static void sort_05v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05) {
            ...
            
        {
            ...
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(max, min, 0xAA);

            s = Shuffle(d05, 0x1B);
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(max, min, 0xCC);
            ...
            max = Max(s, d05);
            d05 = Blend(max, min, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d05, 0x1B)), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(max, min, 0xF0);
        ...
        {        
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d05), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(min, max, 0xF0);
            s = Shuffle(d05, 0x4E);
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(min, max, 0xCC);

            s = Shuffle(d05, 0xB1);
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Blend(min, max, 0xAA);
        }
    }
    ...
    private static void sort_09v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09) {
            ...
            
        {
            ...
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(max, min, 0xAA);

            s = Shuffle(d09, 0x1B);
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(max, min, 0xCC);
            ...
            max = Max(s, d09);
            d09 = Blend(max, min, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d09, 0x1B)), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(max, min, 0xF0);
        ...
        {        
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d09), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(min, max, 0xF0);
            s = Shuffle(d09, 0x4E);
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(min, max, 0xCC);

            s = Shuffle(d09, 0xB1);
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Blend(min, max, 0xAA);
        }
    }
    ...
    private static void sort_17v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17) {
            ...
            
        {
            ...
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(max, min, 0xAA);

            s = Shuffle(d17, 0x1B);
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(max, min, 0xCC);
            ...
            max = Max(s, d17);
            d17 = Blend(max, min, 0xAA);
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(Shuffle(d17, 0x1B)), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(max, min, 0xF0);
        ...
        {        
            ...
            s = Vector256.AsUInt32(Permute4x64(Vector256.AsDouble(d17), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(min, max, 0xF0);
            s = Shuffle(d17, 0x4E);
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(min, max, 0xCC);

            s = Shuffle(d17, 0xB1);
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Blend(min, max, 0xAA);
        }
    }
    ...
    private static void sort_20v_descending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17, ref V d18, ref V d19, ref V d20) {
        ...
        private static void sort_01v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();

      V d01 = Or(MaskLoad(ptr + V.Count * 0, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      sort_01v_ascending(ref d01);
      MaskStore(ptr +  V.Count * 0, mask, d01);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_02v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();

      V d01 = LoadVector256(ptr + V.Count * 0);
      V d02 = Or(MaskLoad(ptr + V.Count * 1, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      sort_02v_ascending(ref d01, ref d02);
      ...
      MaskStore(ptr +  V.Count * 1, mask, d02);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_03v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();

      V d01 = LoadVector256(ptr + V.Count * 0);
      V d02 = LoadVector256(ptr + V.Count * 1);
      V d03 = Or(MaskLoad(ptr + V.Count * 2, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 2, mask, d03);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_04v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d04 = Or(MaskLoad(ptr + V.Count * 3, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      sort_04v_ascending(ref d01, ref d02, ref d03, ref d04);
      Store(ptr + V.Count * 0, d01);
      Store(ptr + V.Count * 1, d02);
      ...
      MaskStore(ptr +  V.Count * 3, mask, d04);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_05v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d05 = Or(MaskLoad(ptr + V.Count * 4, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 4, mask, d05);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_06v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d06 = Or(MaskLoad(ptr + V.Count * 5, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 5, mask, d06);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_07v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d07 = Or(MaskLoad(ptr + V.Count * 6, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 6, mask, d07);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_08v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d08 = Or(MaskLoad(ptr + V.Count * 7, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      sort_08v_ascending(ref d01, ref d02, ref d03, ref d04, ref d05, ref d06, ref d07, ref d08);
      Store(ptr + V.Count * 0, d01);
      Store(ptr + V.Count * 1, d02);
      Store(ptr + V.Count * 2, d03);
      ...
      MaskStore(ptr +  V.Count * 7, mask, d08);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_09v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d09 = Or(MaskLoad(ptr + V.Count * 8, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 8, mask, d09);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_10v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d10 = Or(MaskLoad(ptr + V.Count * 9, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 9, mask, d10);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_11v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d11 = Or(MaskLoad(ptr + V.Count * 10, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 10, mask, d11);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_12v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d12 = Or(MaskLoad(ptr + V.Count * 11, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 11, mask, d12);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_13v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d13 = Or(MaskLoad(ptr + V.Count * 12, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 12, mask, d13);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_14v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d14 = Or(MaskLoad(ptr + V.Count * 13, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 13, mask, d14);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_15v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d15 = Or(MaskLoad(ptr + V.Count * 14, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 14, mask, d15);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_16v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d16 = Or(MaskLoad(ptr + V.Count * 15, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      sort_16v_ascending(ref d01, ref d02, ref d03, ref d04, ref d05, ref d06, ref d07, ref d08, ref d09, ref d10, ref d11, ref d12, ref d13, ref d14, ref d15, ref d16);
      Store(ptr + V.Count * 0, d01);
      Store(ptr + V.Count * 1, d02);
      Store(ptr + V.Count * 2, d03);
      ...
      MaskStore(ptr +  V.Count * 15, mask, d16);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_17v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d17 = Or(MaskLoad(ptr + V.Count * 16, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 16, mask, d17);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_18v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d18 = Or(MaskLoad(ptr + V.Count * 17, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 17, mask, d18);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_19v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d19 = Or(MaskLoad(ptr + V.Count * 18, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 18, mask, d19);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_20v_alt(uint *ptr, int remainder) 
        {        
            var mask = ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)).AsUInt32();
      ...
      V d20 = Or(MaskLoad(ptr + V.Count * 19, mask), AndNot(mask, Vector256.Create(uint.MaxValue)));
      ...
      MaskStore(ptr +  V.Count * 19, mask, d20);
        ...
        public static void Sort(uint* ptr, int length)
        {                    
