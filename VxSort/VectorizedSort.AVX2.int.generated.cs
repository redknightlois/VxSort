...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(int* dataPtr, V P, byte* pBase, ref int* writeLeftPtr, ref int* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((int*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((int*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((int*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((int*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((int*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((int*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((int*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((int*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((int*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((int*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((int*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((int*)(dataPtr + N * 11));
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private int* vectorized_partition_12(int* left, int* right, long hint)
        {
        ...
        internal void sort(int* left, int* right, int left_hint, int right_hint, long hint, int depth_limit)
        {
            ...
            var sep = length < Int32Config.PartitionTempSizeInElements ?
