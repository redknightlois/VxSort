...
namespace VxSort
{
    ...
    static unsafe partial class BitonicSort
    {
        ...
        public static void sort_01v_descending(ref V d01) {
            ...
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Blend(max, min, 0xA);

            s = Permute4x64(d01, 0x1B);
            
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Blend(max, min, 0xC);
    ...
    private static void sort_28v_descending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17, ref V d18, ref V d19, ref V d20, ref V d21, ref V d22, ref V d23, ref V d24, ref V d25, ref V d26, ref V d27, ref V d28) {
      ...
      MaskStore(ptr +  V.Count * 19, mask, d20);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_21v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d21 = Or(MaskLoad(ptr +  V.Count * 20, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 17), d18);
      Store((double *) (ptr +  V.Count * 18), d19);
      Store((double *) (ptr +  V.Count * 19), d20);
      MaskStore(ptr +  V.Count * 20, mask, d21);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_22v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d22 = Or(MaskLoad(ptr +  V.Count * 21, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 18), d19);
      Store((double *) (ptr +  V.Count * 19), d20);
      Store((double *) (ptr +  V.Count * 20), d21);
      MaskStore(ptr +  V.Count * 21, mask, d22);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_23v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d23 = Or(MaskLoad(ptr +  V.Count * 22, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 19), d20);
      Store((double *) (ptr +  V.Count * 20), d21);
      Store((double *) (ptr +  V.Count * 21), d22);
      MaskStore(ptr +  V.Count * 22, mask, d23);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_24v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d24 = Or(MaskLoad(ptr +  V.Count * 23, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 20), d21);
      Store((double *) (ptr +  V.Count * 21), d22);
      Store((double *) (ptr +  V.Count * 22), d23);
      MaskStore(ptr +  V.Count * 23, mask, d24);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_25v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d25 = Or(MaskLoad(ptr +  V.Count * 24, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 21), d22);
      Store((double *) (ptr +  V.Count * 22), d23);
      Store((double *) (ptr +  V.Count * 23), d24);
      MaskStore(ptr +  V.Count * 24, mask, d25);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_26v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d26 = Or(MaskLoad(ptr +  V.Count * 25, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 22), d23);
      Store((double *) (ptr +  V.Count * 23), d24);
      Store((double *) (ptr +  V.Count * 24), d25);
      MaskStore(ptr +  V.Count * 25, mask, d26);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_27v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d27 = Or(MaskLoad(ptr +  V.Count * 26, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 23), d24);
      Store((double *) (ptr +  V.Count * 24), d25);
      Store((double *) (ptr +  V.Count * 25), d26);
      MaskStore(ptr +  V.Count * 26, mask, d27);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_28v_alt(double *ptr, int remainder) 
        {        
            var mask = Vector256.AsDouble(ConvertToVector256Int64(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_4)) + remainder * V.Count)));
      ...
      V d28 = Or(MaskLoad(ptr +  V.Count * 27, mask), AndNot(mask, Vector256.Create(double.MaxValue)));
      ...
      Store((double *) (ptr +  V.Count * 24), d25);
      Store((double *) (ptr +  V.Count * 25), d26);
      Store((double *) (ptr +  V.Count * 26), d27);
