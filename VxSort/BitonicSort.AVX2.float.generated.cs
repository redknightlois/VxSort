...
namespace VxSort
{
    ...
    static unsafe partial class BitonicSort
    {
        ...
        public static void sort_01v_ascending(ref V d01) {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d01), 0xB1));
            
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d01), 0x1B));
            
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));
            ...
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d01), 0x1B)), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d01), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));
        ...
        public static void sort_01v_merge_ascending(ref V d01) {
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d01), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d01), 0x4E));
        ...
        public static void sort_01v_descending(ref V d01) {
            ...
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d01), 0x1B));
            
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));
    ...
    private static void sort_02v_ascending(ref V d01, ref V d02) {
            ...
            
        {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d02), 0xB1));
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d02), 0x1B));
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d02), 0x1B)), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d02), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
        ...
        {        
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d02), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d02), 0x4E));
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d02), 0xB1));
            
            min = Min(s, d02);
            max = Max(s, d02);
            d02 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
        }
    }
    ...
    private static void sort_03v_ascending(ref V d01, ref V d02, ref V d03) {
            ...
            
        {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d03), 0xB1));
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d03), 0x1B));
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d03), 0x1B)), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d03), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
        ...
        {        
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d03), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d03), 0x4E));
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d03), 0xB1));
            
            min = Min(s, d03);
            max = Max(s, d03);
            d03 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
        }
    }
    ...
    private static void sort_05v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05) {
            ...
            
        {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d05), 0xB1));
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d05), 0x1B));
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d05), 0x1B)), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d05), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
        ...
        {        
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d05), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d05), 0x4E));
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d05), 0xB1));
            
            min = Min(s, d05);
            max = Max(s, d05);
            d05 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
        }
    }
    ...
    private static void sort_09v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09) {
            ...
            
        {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d09), 0xB1));
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d09), 0x1B));
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d09), 0x1B)), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d09), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
        ...
        {        
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d09), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d09), 0x4E));
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d09), 0xB1));
            
            min = Min(s, d09);
            max = Max(s, d09);
            d09 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
        }
    }
    ...
    private static void sort_17v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17) {
            ...
            
        {
            ...
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d17), 0xB1));
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d17), 0x1B));
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
            ...
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xAA));
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(Shuffle(Vector256.AsInt32(d17), 0x1B)), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xF0));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d17), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(max), Vector256.AsInt32(min), 0xCC));
        ...
        {        
            ...
            s = Vector256.AsSingle(Permute4x64(Vector256.AsDouble(d17), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xF0));
            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d17), 0x4E));
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xCC));

            s = Vector256.AsSingle(Shuffle(Vector256.AsInt32(d17), 0xB1));
            
            min = Min(s, d17);
            max = Max(s, d17);
            d17 = Vector256.AsSingle(Blend(Vector256.AsInt32(min), Vector256.AsInt32(max), 0xAA));
        }
    }
    ...
    private static void sort_20v_descending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17, ref V d18, ref V d19, ref V d20) {
        ...
        {        
            var mask = Vector256.AsSingle(ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)));
      ...
      MaskStore(ptr +  V.Count * 15, mask, d16);
        ...
        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_17v_alt(float *ptr, int remainder) 
        {        
            var mask = Vector256.AsSingle(ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)));
      ...
      V d17 = Or(MaskLoad(ptr +  V.Count * 16, mask), AndNot(mask, Vector256.Create(float.MaxValue)));
      ...
      Store((float *) (ptr +  V.Count * 13), d14);
      Store((float *) (ptr +  V.Count * 14), d15);
      Store((float *) (ptr +  V.Count * 15), d16);
      MaskStore(ptr +  V.Count * 16, mask, d17);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_18v_alt(float *ptr, int remainder) 
        {        
            var mask = Vector256.AsSingle(ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)));
      ...
      V d18 = Or(MaskLoad(ptr +  V.Count * 17, mask), AndNot(mask, Vector256.Create(float.MaxValue)));
      ...
      Store((float *) (ptr +  V.Count * 14), d15);
      Store((float *) (ptr +  V.Count * 15), d16);
      Store((float *) (ptr +  V.Count * 16), d17);
      MaskStore(ptr +  V.Count * 17, mask, d18);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_19v_alt(float *ptr, int remainder) 
        {        
            var mask = Vector256.AsSingle(ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)));
      ...
      V d19 = Or(MaskLoad(ptr +  V.Count * 18, mask), AndNot(mask, Vector256.Create(float.MaxValue)));
      ...
      Store((float *) (ptr +  V.Count * 15), d16);
      Store((float *) (ptr +  V.Count * 16), d17);
      Store((float *) (ptr +  V.Count * 17), d18);
      MaskStore(ptr +  V.Count * 18, mask, d19);
     }

        [MethodImpl(MethodImplOptions.NoInlining | MethodImplOptions.AggressiveOptimization)]
        private static void sort_20v_alt(float *ptr, int remainder) 
        {        
            var mask = Vector256.AsSingle(ConvertToVector256Int32(LoadVector128((sbyte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(mask_table_8)) + remainder * V.Count)));
      ...
      V d20 = Or(MaskLoad(ptr +  V.Count * 19, mask), AndNot(mask, Vector256.Create(float.MaxValue)));
      ...
      Store((float *) (ptr +  V.Count * 16), d17);
      Store((float *) (ptr +  V.Count * 17), d18);
      Store((float *) (ptr +  V.Count * 18), d19);
