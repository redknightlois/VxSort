...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        private static double* align_left_scalar_uncommon(double* read_left, double pivot, ref double* tmp_left, ref double* tmp_right)
        {
            ...
            var next_align = (double*)(((ulong)read_left + Sort.ALIGN) & ~Sort.ALIGN_MASK);
        ...
        {        
            ...
            var nextAlign = (double*)((ulong)readRight & ~Sort.ALIGN_MASK);
        ...
        private static void align_vectorized(
            ...
            ref double* tmpStartRight, ref double* tmpRight) { throw new NotImplementedException(); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(double* dataPtr, V P, byte* pBase, ref double* writeLeftPtr, ref double* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((double*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((double*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((double*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((double*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((double*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((double*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((double*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((double*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((double*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((double*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((double*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((double*)(dataPtr + N * 11));
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private double* vectorized_partition_12(double* left, double* right, long hint)
        {
        ...
        internal void sort(double* left, double* right, double left_hint, double right_hint, long hint, int depth_limit)
        {
            ...
            var preAlignedLeft = (double*)((ulong)left & ~Sort.ALIGN_MASK);
            ...
            var preAlignedRight = (double*)(((ulong)right - 1 & ~Sort.ALIGN_MASK) + Sort.ALIGN);
            ...
            var sep = length < DoubleConfig.PartitionTempSizeInElements ?
