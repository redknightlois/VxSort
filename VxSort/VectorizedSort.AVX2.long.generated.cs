...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        private static long* align_left_scalar_uncommon(long* read_left, long pivot, ref long* tmp_left, ref long* tmp_right)
        {
            ...
            var next_align = (long*)(((ulong)read_left + Sort.ALIGN) & ~Sort.ALIGN_MASK);
        ...
        {        
            ...
            var nextAlign = (long*)((ulong)readRight & ~Sort.ALIGN_MASK);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(long* dataPtr, V P, byte* pBase, ref long* writeLeftPtr, ref long* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((long*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((long*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((long*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((long*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((long*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((long*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((long*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((long*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((long*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((long*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((long*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((long*)(dataPtr + N * 11));
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private long* vectorized_partition_12(long* left, long* right, long hint)
        {
        ...
        private static void Pack(void* mem, int len, long @base)
        {
            ...
            var pre_aligned_mem = (long*) ( (ulong)mem & ~Sort.ALIGN_MASK );
        ...
        private static void Unpack(void* mem, int len, long @base)
        {
            ...
            var pre_aligned_mem = (int*) ( (ulong)mem_read & ~Sort.ALIGN_MASK );           
        ...
        internal void sort(long* left, long* right, long left_hint, long right_hint, long hint, int depth_limit)
        {
            ...
            var preAlignedLeft = (long*)((ulong)left & ~Sort.ALIGN_MASK);
            ...
            var preAlignedRight = (long*)(((ulong)right - 1 & ~Sort.ALIGN_MASK) + Sort.ALIGN);
            ...
            var sep = length < Int64Config.PartitionTempSizeInElements ?
