...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        private static float* align_left_scalar_uncommon(float* read_left, float pivot, ref float* tmp_left, ref float* tmp_right)
        {
            ...
            var next_align = (float*)(((ulong)read_left + Sort.ALIGN) & ~Sort.ALIGN_MASK);
        ...
        {        
            ...
            var nextAlign = (float*)((ulong)readRight & ~Sort.ALIGN_MASK);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(float* dataPtr, V P, byte* pBase, ref float* writeLeftPtr, ref float* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((float*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((float*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((float*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((float*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((float*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((float*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((float*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((float*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((float*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((float*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((float*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((float*)(dataPtr + N * 11));
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private float* vectorized_partition_12(float* left, float* right, long hint)
        {
        ...
        internal void sort(float* left, float* right, float left_hint, float right_hint, long hint, int depth_limit)
        {
            ...
            var preAlignedLeft = (float*)((ulong)left & ~Sort.ALIGN_MASK);
            ...
            var preAlignedRight = (float*)(((ulong)right - 1 & ~Sort.ALIGN_MASK) + Sort.ALIGN);
            ...
            var sep = length < FloatConfig.PartitionTempSizeInElements ?
