...
namespace VxSort
{
    ...
    static unsafe partial class BitonicSort
    {
        ...
        public static void sort_01v_ascending(ref V d01) {
            ...
            max = Max(s, d01);
            d01 = Blend(min, max, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d01, 0x1B)), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
        ...
        public static void sort_01v_merge_ascending(ref V d01) {
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d01), 0x4E));
            min = Min(s, d01);
            max = Max(s, d01);
            d01 = Blend(min, max, 0xF0);
            s = Shuffle(d01, 0x4E);
    ...
    private static void sort_02v_ascending(ref V d01, ref V d02) {
            ...
            
        {
            ...
            max = Max(s, d02);
            d02 = Blend(max, min, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d02, 0x1B)), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
        ...
        {        
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d02), 0x4E));
            min = Min(s, d02);
            max = Max(s, d02);
    ...
    private static void sort_03v_ascending(ref V d01, ref V d02, ref V d03) {
            ...
            
        {
            ...
            max = Max(s, d03);
            d03 = Blend(max, min, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d03, 0x1B)), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
        ...
        {        
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d03), 0x4E));
            min = Min(s, d03);
            max = Max(s, d03);
    ...
    private static void sort_05v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05) {
            ...
            
        {
            ...
            max = Max(s, d05);
            d05 = Blend(max, min, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d05, 0x1B)), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
        ...
        {        
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d05), 0x4E));
            min = Min(s, d05);
            max = Max(s, d05);
    ...
    private static void sort_09v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09) {
            ...
            
        {
            ...
            max = Max(s, d09);
            d09 = Blend(max, min, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d09, 0x1B)), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
        ...
        {        
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d09), 0x4E));
            min = Min(s, d09);
            max = Max(s, d09);
    ...
    private static void sort_17v_ascending(ref V d01, ref V d02, ref V d03, ref V d04, ref V d05, ref V d06, ref V d07, ref V d08, ref V d09, ref V d10, ref V d11, ref V d12, ref V d13, ref V d14, ref V d15, ref V d16, ref V d17) {
            ...
            
        {
            ...
            max = Max(s, d17);
            d17 = Blend(max, min, 0xAA);
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(Shuffle(d17, 0x1B)), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
        ...
        {        
            ...
            s = Vector256.AsInt32(Permute4x64(Vector256.AsDouble(d17), 0x4E));
            min = Min(s, d17);
            max = Max(s, d17);
