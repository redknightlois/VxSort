...
namespace VxSort
{
    ...
    internal unsafe partial struct Avx2VectorizedSort
    {
        ...
        private static uint* align_left_scalar_uncommon(uint* read_left, uint pivot, ref uint* tmp_left, ref uint* tmp_right)
        {
            ...
            var next_align = (uint*)(((ulong)read_left + Sort.ALIGN) & ~Sort.ALIGN_MASK);
        ...
        {        
            ...
            var nextAlign = (uint*)((ulong)readRight & ~Sort.ALIGN_MASK);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private static void LoadAndPartition12Vectors(uint* dataPtr, V P, byte* pBase, ref uint* writeLeftPtr, ref uint* writeRightPtr)
        {
            // PERF: Unroll and CompressWrite support is been treated as a constant because we make sure the caller
            //       treats that parameter already as a constant @ JIT time causing a cascade.
            ...
            var d12 = LoadAlignedVector256((uint*)(dataPtr + N * 0));
            var d11 = LoadAlignedVector256((uint*)(dataPtr + N * 1));
            var d10 = LoadAlignedVector256((uint*)(dataPtr + N * 2));
            var d9 = LoadAlignedVector256((uint*)(dataPtr + N * 3));
            var d8 = LoadAlignedVector256((uint*)(dataPtr + N * 4));
            var d7 = LoadAlignedVector256((uint*)(dataPtr + N * 5));
            var d6 = LoadAlignedVector256((uint*)(dataPtr + N * 6));
            var d5 = LoadAlignedVector256((uint*)(dataPtr + N * 7));
            var d4 = LoadAlignedVector256((uint*)(dataPtr + N * 8));
            var d3 = LoadAlignedVector256((uint*)(dataPtr + N * 9));
            var d2 = LoadAlignedVector256((uint*)(dataPtr + N * 10));
            var d1 = LoadAlignedVector256((uint*)(dataPtr + N * 11));
        ...
        [SkipLocalsInit]
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        private uint* vectorized_partition_12(uint* left, uint* right, long hint)
        {
        ...
        internal void sort(uint* left, uint* right, uint left_hint, uint right_hint, long hint, int depth_limit)
        {
            ...
            var preAlignedLeft = (uint*)((ulong)left & ~Sort.ALIGN_MASK);
            ...
            var preAlignedRight = (uint*)(((ulong)right - 1 & ~Sort.ALIGN_MASK) + Sort.ALIGN);
            ...
            var sep = length < UInt32Config.PartitionTempSizeInElements ?
