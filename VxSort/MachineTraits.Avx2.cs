...
namespace VxSort
{
    internal struct AvxInt32MachineParameters : IMachineParameters
    {
        public int N => Vector256<int>.Count;

        public int ELEMENT_ALIGN => sizeof(int) - 1;
    }

    internal struct AvxInt64MachineParameters : IMachineParameters
    {
        public int N => Vector256<long>.Count;

        public int ELEMENT_ALIGN => sizeof(long) - 1;
    }

    internal unsafe struct Avx2InstructionSet<TParams> : IMachineTraits<TParams>
            where TParams : struct, IMachineParameters
    {
        ...
        public bool supports_compress_writes
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get { return false; }
        }

        public bool supports_packing
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get { return false; }
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector add<TVector>(in TVector a, in TVector b)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector broadcast<T, TVector>(T pivot)
            where TVector : unmanaged
            where T : unmanaged
        {
            if (typeof(T) == typeof(int))
            {
                return (TVector)(object)Vector256.Create((int)(object)pivot);
            }
            else if (typeof(T) == typeof(long))
            {
                return (TVector)(object)Vector256.Create((long)(object)pivot);
            }
            throw new NotSupportedException();
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public uint get_cmpgt_mask<TVector>(in TVector a, in TVector b)
            where TVector : unmanaged
        {
            if (typeof(TVector) == typeof(Vector256<int>))
            {
                var aiv = (Vector256<int>)(object)a;
                var biv = (Vector256<int>)(object)b;
                return (uint)Avx2.MoveMask(i2s(Avx2.CompareGreaterThan(aiv, biv)));
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe void load_vec<TVector>(void* ptr, out TVector vector)
            where TVector : unmanaged
        {
            if (typeof(TVector) == typeof(Vector256<int>))
            {
                vector = (TVector)(object)Avx2.LoadAlignedVector256((int*)ptr);
                return;
            }
            else if (typeof(TVector) == typeof(Vector256<long>))
            {
                vector = (TVector)(object)Avx2.LoadAlignedVector256((long*)ptr);
                return;
            }
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector pack_ordered<TVector>(in TVector a, in TVector b)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector pack_unordered<TVector>(in TVector a, in TVector b)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector partition_vector<TVector>(in TVector v, uint mask)
            where TVector : unmanaged
        {
            Debug.Assert(mask >= 0);
            Debug.Assert(mask <= 255);
            if (typeof(TVector) == typeof(Vector256<int>))
            {
                var vi = (Vector256<int>)(object)v;
                var table = Avx2.ConvertToVector256Int32(
                                Sse2.LoadVector128(
                                    (byte*)Unsafe.AsPointer(ref MemoryMarshal.GetReference(perm_table_32)) + (ulong)mask * 8));

                //return (TVector)(object)s2i<int>(Avx2.PermuteVar8x32(i2s<int>(vi), table));
                return (TVector)(object)Avx2.PermuteVar8x32(vi.AsUInt32(), table.AsUInt32()).AsInt32();
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int popcnt(uint mask)
        {
            return (int)Popcnt.PopCount(mask);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector shift_left<TVector>(in TVector v, int i)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector shift_right<TVector>(in TVector v, int i)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe void store_compress_vec<TVector>(void* ptr, in TVector v)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public unsafe void store_vec<TVector>(void* ptr, in TVector v)
            where TVector : unmanaged
        {
            if (typeof(TVector) == typeof(Vector256<int>))
            {
                var vi = (Vector256<int>)(object)v;
                Avx2.Store((int*)ptr, vi);
                return;
            }
            else if (typeof(TVector) == typeof(Vector256<long>))
            {
                var vi = (Vector256<long>)(object)v;
                Avx2.Store((long*)ptr, vi);
                return;
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TVector sub<TVector>(in TVector a, in TVector b)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void unpack_ordered<TVector>(in TVector p, ref TVector u1, ref TVector u2)
            where TVector : unmanaged
        {
            throw new NotImplementedException();
        }
